...
* HUD_COLOUR_VIDEO_EDITOR_AMBIENT: HUD_COLOUR_YELLOW
* HUD_COLOUR_VIDEO_EDITOR_AMBIENT_FADEOUT: rgba(80, 70, 34, 255)
* HUD_COLOUR_VIDEO_EDITOR_AMBIENT_DARK: HUD_COLOUR_ORANGE
* HUD_COLOUR_VIDEO_EDITOR_AMBIENT_LIGHT: HUD_COLOUR_ORANGELIGHT
* HUD_COLOUR_VIDEO_EDITOR_AMBIENT_MID: HUD_COLOUR_ORANGE
* HUD_COLOUR_LOW_FLOW: HUD_COLOUR_YELLOW
* HUD_COLOUR_LOW_FLOW_DARK: HUD_COLOUR_YELLOWDARK
...
* HUD_COLOUR_STUNT_2: HUD_COLOUR_RED
...
* HUD_COLOUR_JUNK_ENERGY: rgba(29, 237, 195, 255)

## Notes
Data can be found in common:/data/ui/hudcolor.dat